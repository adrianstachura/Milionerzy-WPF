...
{"Który z wymienionych kolorów NIE widnieje na fladze Wielkiej Brytanii?", "Zielony", "Bialy", "Niebieski", "Czerwony", "1",  String.Empty
},
{"Stolicą jakiego kraju jest Damaszek?", "Polski", "Francji", "Afganistanu", "Syrii", "4",  String.Empty},
{"Nad jaką rzeką leży Opole", "Wisla", "Nil", "Odra", "Warta", "3",  String.Empty},
...
{"W jakim województwie położony jest Radom?", "Malopolskim", "Mazowieckim", "Podkarpackie", "Wielkopolskie", "2",  String.Empty},
